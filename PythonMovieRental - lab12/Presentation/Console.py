...
class UI():
    ...
    def __init__(self, moviesService, clientsService, rentalService):
        ...
        self.__commands = {
            ...
            "add_client_recursiv":self.__ui_AddClient_recursiv,
            ...
            "ordonare_gen":self.__ui__ordonare_dupa_nr_gen,
    ...
    def     __ui__RentMovie_recursiv(self):
        """
        Rent a movie
        :return:
        """
    ...
    def __ui_AddClient_recursiv(self):
        """
        Adauga client.
        param1:ID
        param2:Nume
        ...
        self.__clientsService.add_recursive(self.__clientsService.getAllClients(),client,0)
        print("Client adaugat cu succes!")
    ...
    def __ui__ordonare_dupa_nume(self):
        if len(self.__params) != 0:
            print("numar parametri invalid!")
            return
        list = self.__clientsService.ordonare_dupa_nume(self.__clientsService.getAllClients())
        print(list)
        for client in list:
            print(client)
    ...
    def __ui__orodnare_dupa_nr_inchirieri(self):
        ...
        list = self.__moviesService.ordonare_dupa_nr(self.__moviesService.getAllMovies())
        if len(list) == 0:
    ...
    def __ui__ordonare_dupa_nr_gen(self):
        """
        ...
        list = self.__moviesService.ordonare_dupa_nr_gen(self.__moviesService.getAllMovies())
        if len(list) == 0:
            print("Nu exista inchirieri!")
            return
        for client in list:
    ...
    def __ui__cel_mai_putin_inchiriat(self):
        ...
        #print(f"Cel mai putin inchiriat film este {self.__moviesService.cel_mai_putin_inchiriat().GetId}")
...
""" Add-urile mai au nevoie de ajustare in cazul in care vrem sa adaugam un client care a fost sters deja, nu cred ca voi face asta vreodata dar macar sa stiu ca am observat treaba asta la un moment dat. :)
"""